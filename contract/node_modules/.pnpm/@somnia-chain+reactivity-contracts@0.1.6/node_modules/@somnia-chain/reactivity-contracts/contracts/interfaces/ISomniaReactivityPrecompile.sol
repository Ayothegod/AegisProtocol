...
interface ISomniaReactivityPrecompile {
    ...
    struct SubscriptionData {
        ...
        address origin;
        // Caller (msg.sender) filter, use address(0) to indicate a wildcard
        address caller;
        ...
        // The function selector in the handler contract, defaults to ISomniaEventHandler.handleEvent
     ...
     * @dev Cost: SUBSCRIPTION_MANAGEMENT_GAS_COST (~21k GAS)
     ...
     * @return subscriptionData The recorded subsctiption information
